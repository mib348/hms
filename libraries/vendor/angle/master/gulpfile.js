...
var source = {
    ...
    templates: {
        app: {
            files: [paths.markup + 'index.pug'],
            watch: [paths.markup + 'index.pug', paths.markup + hidden_files]
        },
        partials: {
        ...
        views: {
            files: [paths.markup + 'views/**/*.pug'],
            watch: [paths.markup + 'views/**/*.pug']
        },
        pages: {
            files: [paths.markup + 'pages/*.pug'],
            watch: [paths.markup + 'pages/*.pug']
        }
    },
    styles: {
        app: [paths.styles + '*.*'],
...
gulp.task('watch', function() {
    ...
    // Pug partials (forces to rebuild all templates)
...
gulp.task('clean', function(done) {
    var delconfig = [].concat(
        ...
        build.templates.views + '*.html',
        build.templates.pages + '*.html',
        vendor.app.dest
    );
