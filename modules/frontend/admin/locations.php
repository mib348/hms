...
<div class="content-heading">Location</div>
<div class="row">
	<div class="col-xs-12">
			...
			<div class="panel-body">
				...
				<form id="filter_form" role="form">
					<div class="form-group">
						<div class="col-xs-12 col-sm-2">
							...
							<?php TableComboMsSql("SubDepartments", "Name", "SubDepartmentId", " IsActive = 1 order by Name asc", "nFilterSubDeptId", "", "", "--- Select ---", "", "form-control searchable");?>
						</div>
						<div class="col-xs-12 col-sm-2">
							<label>Name</label> 
				...
				<form id="insertion_form" data-parsley-validate="">
					...
					<div class="form-group">
						<div class="col-xs-12 col-sm-2">
							<label>Sub Department</label> 
							<?php TableComboMsSql("SubDepartments", "Name", "SubDepartmentId", " IsActive = 1 order by Name asc", "nSubDeptId", "", "", "--- Select ---", "", "form-control searchable", "required");?>
						</div>
						<div class="col-xs-12 col-sm-2">
							<label>Name</label> 
							<input type="text" class="form-control" id="strLocation" name="strLocation" required/>
						</div>
						<div class="col-xs-12 col-sm-2">
		...
		$(document).on("click", ".edit_btn", function(){
			$("#nLocId").val($(this).parent().parent().attr("id"));
		      $.ajax({
		        ...
		        success: function(data)
		        {
		        	$("#strLocation").val(data['rstRow']['Name']);
		        	$("#nSubDeptId").val(data['rstRow']['SubDepartmentId']).trigger('change');
