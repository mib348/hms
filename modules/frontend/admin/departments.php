...
<div class="content-heading">Departments</div>
<div class="row">
	<div class="col-xs-12">
			...
			<div class="panel-body">
				...
				<form id="insertion_form" data-parsley-validate="">
					...
					<div class="form-group">
						<div class="col-xs-12 col-sm-2">
							<label>Name</label> 
							<input type="text" class="form-control" id="strDepartment" name="strDepartment" required/>
						</div>
						<div class="col-xs-12 col-sm-2">
		...
		$(document).on("click", ".edit_btn", function(){
			$("#nDeptId").val($(this).parent().parent().attr("id"));
		      $.ajax({
		        ...
		        success: function(data)
		        {
		        	$("#strDepartment").val(data['rstRow']['Name']);
