<?php 
    ...
    GenerateLog("User accessed Sub Departments Admin Page", ucwords($strModule));
?>
<style>
...
<div class="content-heading">Sub Departments</div>
<div class="row">
	<div class="col-xs-12">
			...
			<div class="panel-body">
				...
				<form id="filter_form" role="form">
					<div class="form-group">
						<div class="col-xs-12 col-sm-2">
							...
							<?php TableComboMsSql("Departments", "Name", "DepartmentId", " IsActive = 1 order by Name asc", "nFilterDeptId", "", "", "--- Select ---", "", "form-control searchable");?>
						</div>
						<div class="col-xs-12 col-sm-2">
							<label>Name</label> 
				...
				<form id="insertion_form" data-parsley-validate="">
					...
					<div class="form-group">
						<div class="col-xs-12 col-sm-2">
							<label>Department</label> 
							<?php TableComboMsSql("Departments", "Name", "DepartmentId", " IsActive = 1 order by Name asc", "nDeptId", "", "", "--- Select ---", "", "form-control searchable", "required");?>
						</div>
						<div class="col-xs-12 col-sm-2">
							<label>Name</label> 
							<input type="text" class="form-control" id="strSubDepartment" name="strSubDepartment" required/>
						</div>
						<div class="col-xs-12 col-sm-2">
		...
		$(document).on("click", ".edit_btn", function(){
			$("#nSubDeptId").val($(this).parent().parent().attr("id"));
		      $.ajax({
		        ...
		        success: function(data)
		        {
		        	$("#strSubDepartment").val(data['rstRow']['Name']);
		        	$("#nDeptId").val(data['rstRow']['DepartmentId']).trigger('change');
